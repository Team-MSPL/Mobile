...
const chinaCityList = [
	{
		...
		sub: [
			...
			{id: 4, subId: 3, subTitle: '홍콩'},
			{id: 4, subId: 4, subTitle: '마카오'},
...
const tailandCityList = [
	{
		...
		sub: [
			...
			{id: 6, subId: 1, subTitle: '파타야'},
			{id: 4, subId: 1, subTitle: '푸켓'},
			{id: 2, subId: 1, subTitle: '치앙마이'},
			{id: 2, subId: 2, subTitle: '치앙라이'},
			{id: 4, subId: 4, subTitle: '피피돈 섬'},
			{id: 5, subId: 2, subTitle: '후아힌'},
			{id: 4, subId: 2, subTitle: '사무이 섬'},
		],
	},
	// {
	// 	id: 1,
