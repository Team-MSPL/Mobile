...
export default function MealSelector({
	...
	const stored = customMap?.[cusType]?.meal ?? null;
	...
	useEffect(() => {
		if (selectedId !== null) {
			dispatch(setCustomField({cusType, fieldId: 'meal', value: selectedId}));
			onValueChange?.(selectedId);
		} else {
			dispatch(setCustomField({cusType, fieldId: 'meal', value: ''}));
			onValueChange?.(null);
		}
		// eslint-disable-next-line react-hooks/exhaustive-deps
	}, [selectedId, cusType]);
