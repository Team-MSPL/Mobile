...
export default function ContactAppSelector({
	...
	const stored = customMap?.[cusType]?.contact_app ?? '';
	...
	useEffect(() => {
		if (selectedType !== null) {
			dispatch(setCustomField({cusType, fieldId: 'contact_app', value: selectedType}));
			onValueChange?.(selectedType);
		} else {
			dispatch(setCustomField({cusType, fieldId: 'contact_app', value: ''}));
			onValueChange?.(null);
		}
		// eslint-disable-next-line react-hooks/exhaustive-deps
