...
export default function CarPsgChildInput({
	trafficType,
	label = '어린이 수',
	placeholder = '0',
	required = false,
	...
	const stored = trafficArray?.find(it => String(it?.traffic_type) === String(trafficType))?.carpsg_child ?? null;
	...
	return (
		<View style={{marginBottom: 12}}>
			...
			<ProductInfoInput
				...
				accessibilityLabel={`carpsg-child-${trafficType}`}
			/>
		</View>
	);
}
