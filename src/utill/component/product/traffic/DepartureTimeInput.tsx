...
export default function DepartureTimeInput({
	trafficType,
	label = '출발 시간',
	placeholder = 'HH:mm',
	required = false,
	...
	const stored = trafficArray?.find(it => String(it?.traffic_type) === String(trafficType))?.departure_time ?? null;
