...
export default function ArrivalFlightNoInput({
	trafficType,
	label = '도착 편명',
	placeholder = '예) BR111',
	required = false,
	...
	const stored = trafficArray?.find(it => String(it?.traffic_type) === String(trafficType))?.arrival_flightNo ?? null;
