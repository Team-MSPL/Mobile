...
export default function LuggageCheckInput({
	trafficType,
	label = '위탁 수하물 수',
	placeholder = '0',
	required = false,
	...
	const stored = trafficArray?.find(it => String(it?.traffic_type) === String(trafficType))?.luggage_check ?? null;
	...
	return (
		<View style={{marginBottom: 12}}>
			...
			<ProductInfoInput
				...
				accessibilityLabel={`luggage-check-${trafficType}`}
			/>
		</View>
	);
}
