...
export default function CarPsgInfantInput({
	trafficType,
	label = '유아 수',
	placeholder = '0',
	required = false,
	...
	const stored = trafficArray?.find(it => String(it?.traffic_type) === String(trafficType))?.carpsg_infant ?? null;
	...
	return (
		<View style={{marginBottom: 12}}>
			...
			<ProductInfoInput
				...
				accessibilityLabel={`carpsg-infant-${trafficType}`}
			/>
		</View>
	);
}
