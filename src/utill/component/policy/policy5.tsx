...
export default function Policy5() {
	return (
		<>
			<PolicyTextContainer>
				<PolicyMainText> 제30조 취소 및 환불</PolicyMainText>
				<PolicySubText>
					{' '}
			...
			<PolicyTextContainer>
				<PolicyMainText>제31조(과오금)</PolicyMainText>
				<PolicySubText>
					{' '}
			...
			<PolicyTextContainer>
				<PolicyMainText>제32조(콘텐츠하자 등에 의한 이용자피해보상)</PolicyMainText>
				<PolicySubText>
					{' '}
			...
			<PolicyTextContainer>
				<PolicyMainText>제33조(면책조항)</PolicyMainText>
				<PolicySubText>
					{' '}
			...
			<PolicyTextContainer>
				<PolicyMainText>제34조(분쟁의 해결)</PolicyMainText>
				<PolicySubText>
					{' '}
