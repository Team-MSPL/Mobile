		...
		<>
			...
			<PolicyTextContainer>
				...
				<PolicySubText>
					...
					배상합니다.{'\n '}⑥"회사"는 "콘텐츠"의 일정 부분은 저작권이 있는 자료를 사용할 수 있으며 "회사"는
					이러한 사용 사실을 인정합니다. "회사"는 "통지 및 삭제" 기준에 따라 운영됩니다. "이용자"가 서비스에
					게시된 이용자 메시지를 포함해서 컨텐츠에 불만 또는 이의가 있거나, "콘텐츠"에 게시된 자료나 컨텐츠가
					귀하가 보유하는 저작권을 침해한다고 생각되는 경우, "회사"의 통지 및 삭제 절차에 따라 즉시 당사에
					연락하시기 바랍니다. 이러한 절차가 취해지는 경우 "회사"는 합리적인 기간 내에 불법 컨텐츠를
					제거하려는 모든 합당한 노력을 기울이는 방식으로 유효한 것으로 적절히 입증된 불만 사항에 대처합니다.
				</PolicySubText>
			</PolicyTextContainer>
			<PolicyTextContainer>
			...
			<PolicyTextContainer>
				...
				<PolicySubText>
					...
					삭제 정책 "회사"는 "통지 및 삭제" 기준에 따라 운영됩니다. 귀하가 서비스에 게시된 이용자 메시지를
					포함해서 컨텐츠에 불만 또는 이의가 있거나, 서비스에 게시된 자료나 컨텐츠가 귀하가 보유하는 저작권을
					침해한다고 생각되는 경우, 당사의 통지 및 삭제 절차에 따라 즉시 당사에 연락하시기 바랍니다. 저작권
					정책 및 절차를 살펴보려면 여기를 클릭하시기 바랍니다. 이러한 절차가 취해지는 경우 "회사"는 합리적인
					기간 내에 불법 컨텐츠를 제거하려는 모든 합당한 노력을 기울이는 방식으로 유효한 것으로 적절히 입증된
					불만 사항에 대처합니다.
				</PolicySubText>
			</PolicyTextContainer>
			<PolicyTextContainer>
